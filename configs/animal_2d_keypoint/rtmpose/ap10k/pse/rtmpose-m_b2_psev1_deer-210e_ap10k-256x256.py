...
base_lr = 1e-4
load_from = 'configs/animal_2d_keypoint/rtmpose/ap10k/b_AP_epoch_200.pth'
train_cfg = dict(max_epochs=max_epochs, val_interval=10)
randomness = dict(seed=21)

# optimizerannotation_list_Cervidae
optim_wrapper = dict(
    type='OptimWrapper',
...
val_evaluator = dict(
    type='CocoMetric_Cls',
    ann_file=data_root + 'annotations/ap10k-train-split1.json',cls_val = [17])
test_evaluator = dict(
    type='CocoMetric',
